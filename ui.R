      ...
      tabItems(
        ...
        tabItem("intro",
                ...
                fluidRow(
                  ...
                  The open linked movie data, known as triples, is part of open knowledge graph ",a("DBpedia", href= "http://dbpedia.org"), ". 
                  ...
                  You may find the Movies incompleted."),
                  p(),
                  p("The Spinner below indicates that the data is currently transformed on the first run. Please wait until you 
